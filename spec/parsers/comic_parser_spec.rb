...
RSpec.describe DiamondComicsParser do
  ...
  context 'parses comic info' do
    ...
    it 'cover image' do
      expect(parser.parse_cover_image(@noko_doc)).to eq('https://www.previewsworld.com/SiteImage/CatalogImage/STL006317?type=1')
    end
    ...
    context 'creator names' do
      let(:creators_class) { 'class="Creators"' }
      it 'when (W) (A) (CA)' do
  ...
  it 'builds correct hash from parsed page' do
    ...
    expect(parser.parse_comic_info(comic_page)).to eq({ title: 'ABE SAPIEN',
                                                        ...
                                                        additional_info: {},
                                                        cover_image_url: 'https://www.previewsworld.com/SiteImage/CatalogImage/STL006317?type=1',
